...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput("dir", "File Directory: enter your folder pathway where the Surveillance Data is located", " "),
      # br(),
      #Demo_Data.xlsx
      textInput("original_data_file_name", "Enter the file name of the Surveillance Data including the extension (.xls or xlsx)", " "),
      #br(),
      ...
      #br(),
      numericInput("alarm_window","Enter the window size (e.g 2) for measuring the mean alarm indicator including current week", value = 3),
      # br(),
      ...
      # br(),
      numericInput("outbreak_window","Enter the choice of outbreak window (e.g 3)", value = 4),
      #br(),
      ...
      # br(),
      numericInput("outbreak_threshold","Enter a choice of cut-off value to define the outbreak signal (e.g 0.25)", value = 0.75),
      # br(),
